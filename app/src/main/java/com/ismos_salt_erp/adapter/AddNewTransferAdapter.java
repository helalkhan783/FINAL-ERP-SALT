...
import com.ismos_salt_erp.view.fragment.transfer.addNew.AddNewTransferItemClickHandle;
...
public class AddNewTransferAdapter extends RecyclerView.Adapter<AddNewTransferAdapter.MyHolder> {
    ...
    public AddNewTransferAdapter(FragmentActivity context, List<SalesRequisitionItems> list, List<ProductStockListResponse> productStockResponse, AddNewTransferItemClickHandle itemClick,List<ProductStockListResponse> stockList) {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyHolder holder, int position) {
        ...
        ProductStockListResponse stockCurrent = stockList.get(position);
       try {
           ...
           holder.binding.stock.setText(""+stockCurrent.getStockQty());
           ...
           if (productStockResponse != null) {
               for (int i = 0; i < productStockResponse.size(); i++) {
                   if (currentItem.getProductID().equals(productStockResponse.get(i).getProductID())) {
                       ...
                       holder.binding.stock.setText("" + productStockResponse.get(i).getStockQty());
                   }
               }
           }
       }catch (Exception e){}
        ...
        holder.binding.setClickHandle(new NewSaleProductListClickHandle() {
            ...
            public void addQuantity() {
              ...
              // now insert data to local database
