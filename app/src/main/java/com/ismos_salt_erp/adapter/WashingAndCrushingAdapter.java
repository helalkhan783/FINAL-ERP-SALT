...
import com.ismos_salt_erp.view.fragment.production.washingAndCrushing.addNew.WashingAndCrushing;
import com.ismos_salt_erp.view.fragment.production.washingAndCrushing.addNew.WashingAndCrushingAdapterItemClick;
...
public class WashingAndCrushingAdapter extends RecyclerView.Adapter<WashingAndCrushingAdapter.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull MyHolder holder, int position) {
        ...
        ProductStockListResponse stockList = stockListResponses.get(position);
        ...
        try {
            ...
            holder.binding.stock.setText("" + stockList.getStockQty());
