...
import com.ismos_salt_erp.view.fragment.reconciliation.edit.EditReconcilationData;
import com.ismos_salt_erp.view.fragment.reconciliation.edit.EditReconciliationItemClick;
...
public class EditReconciliationAdapter extends RecyclerView.Adapter<EditReconciliationAdapter.MyHolder>{
    ...
    public EditReconciliationAdapter(FragmentActivity context, List<SalesRequisitionItems> list, List<ProductStockListResponse> productStockResponse, EditReconciliationItemClick itemClick) {
