...
public class ConfirmSaleAdapterOne extends RecyclerView.Adapter<ConfirmSaleAdapterOne.MyHolder> {
    private FragmentActivity context;
    private List<SalesRequisitionItems> list;
    SalesRequisitionItems currentItem;
    ConfirmNewSale click;

    public ConfirmSaleAdapterOne(FragmentActivity context, List<SalesRequisitionItems> list, ConfirmNewSale click) {
    ...
    @NotNull
    @Override
    public ConfirmSaleAdapterOne.MyHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        LayoutOneBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext())
                , R.layout.layout_one, parent, false);
        return new ConfirmSaleAdapterOne.MyHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull ConfirmSaleAdapterOne.MyHolder holder, int position) {
    ...
    private void Update(double totalQty, double price, String productID, MyHolder
