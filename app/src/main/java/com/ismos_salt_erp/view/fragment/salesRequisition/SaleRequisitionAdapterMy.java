...
public class SaleRequisitionAdapterMy  extends RecyclerView.Adapter<SaleRequisitionAdapterMy.MyHolder> {
    ...
    public SaleRequisitionAdapterMy(FragmentActivity context,
    ...
    @NotNull
    @Override
    public SaleRequisitionAdapterMy.MyHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        return new SaleRequisitionAdapterMy.MyHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull SaleRequisitionAdapterMy.MyHolder holder, int position) {
     ...
     //   ProductStockListResponse stockQty =   stockListResponses.get(position);
       ...
       //     holder.binding.stock.setText(""+stockQty.getStockQty());
            ...
            NewSaleFragment.totalSubmitBtn.setText("Total Quantity: " + String.valueOf(totalQuantity));
        ...
        holder.binding.setClickHandle(new NewSaleProductListClickHandle() {
            ...
            public void addQuantity() {
                ...
                List<String> quantityList = NewSaleFragment.getAllQuantity();
                ...
                try {
                    NewSaleFragment.totalSubmitBtn.setText("Total Quantity: " + String.valueOf(total));
                } catch (Exception e) {
    ...
    private void insertAllDataToLocal(SaleRequisitionAdapterMy.MyHolder holder) {
        if (quantity > 0) {
