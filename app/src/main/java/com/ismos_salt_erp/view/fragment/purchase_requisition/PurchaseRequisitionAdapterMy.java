...
public class PurchaseRequisitionAdapterMy extends RecyclerView.Adapter<PurchaseRequisitionAdapterMy.MyHolder> {
    ...
    public PurchaseRequisitionAdapterMy(FragmentActivity context,
    ...
    @NotNull
    @Override
    public PurchaseRequisitionAdapterMy.MyHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        ...
        return new PurchaseRequisitionAdapterMy.MyHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull PurchaseRequisitionAdapterMy.MyHolder holder, int position) {
        ...
        try {
            ...
            PurchaseRequisitonFragment.binding.totalSubmitBtn.setText("Total Quantity: " + String.valueOf(totalQuantity));
        ...
        holder.binding.setClickHandle(new NewSaleProductListClickHandle() {
            ...
            public void addQuantity() {
                ...
                List<String> quantityList =   PurchaseRequisitonFragment.getAllQuantity();
                ...
                try {
                    PurchaseRequisitonFragment.binding.totalSubmitBtn.setText("Total Quantity: " + String.valueOf(total));
                } catch (Exception e) {
    ...
    private void insertAllDataToLocal(PurchaseRequisitionAdapterMy.MyHolder holder) {
        if (quantity > 0) {
