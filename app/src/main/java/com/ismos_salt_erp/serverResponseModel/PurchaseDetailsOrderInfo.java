...
public class PurchaseDetailsOrderInfo {
    ...
    @SerializedName("ref_order_serial")
    @Expose
    private String ref_order_serial;
    ...
    public String getRef_order_serial() {
        return ref_order_serial;
    }

    public void setRef_order_serial(String ref_order_serial) {
        this.ref_order_serial = ref_order_serial;
    }
