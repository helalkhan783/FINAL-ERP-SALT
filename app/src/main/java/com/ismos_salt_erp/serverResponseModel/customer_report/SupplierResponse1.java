...
public class SupplierResponse1 {
    ...
    @SerializedName("list")
    @Expose
    public List<SupplierRepostList1> list = null;
    ...
    public List<SupplierRepostList1> getList() {
        return list;
    }

    public void setList(List<SupplierRepostList1> list) {
        this.list = list;
    }
